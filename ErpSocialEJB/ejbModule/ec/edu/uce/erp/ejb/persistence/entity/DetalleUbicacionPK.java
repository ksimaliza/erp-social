 ...
 */
@Embeddable
public class DetalleUbicacionPK implements Serializable {
	//default serial version id, required for serializable classes.
	private static final long serialVersionUID = 1L;

	@Column(name="cab_ubicacion_fk", insertable=false, updatable=false)
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof DetalleUbicacionPK)) {
			return false;
		}
		DetalleUbicacionPK castOther = (DetalleUbicacionPK)other;
		return 
