...
/**
 * The persistent class for the asi_empleado_permiso_vie database table.
 * 
 */
@Entity
@Table(name="asi_empleado_permiso_vie")
@NamedQuery(name="PermisoListDTO.findAll", query="SELECT p FROM PermisoListDTO p")
public class PermisoListDTO implements Serializable {
