...
/**
 * The persistent class for the mat_docente_asignado_vie database table.
 * 
 */
@Entity
@Table(name="mat_docente_asignado_vie")
@NamedQuery(name="DocenteAsignadoVieDTO.findAll", query="SELECT m FROM DocenteAsignadoVieDTO m")
public class DocenteAsignadoVieDTO implements Serializable {
	...
	public DocenteAsignadoVieDTO() {
	}


	public DocenteAsignadoVieDTO(Integer proCodigo, String perCi, String perApellidos,
			String perNombres) {
		super();
